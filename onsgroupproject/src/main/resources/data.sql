...
insert into users (first_name ,sure_name,email,privacy) values('lora','m','loraM@gmail.com', false);
insert into user_skill( user_id , skill_id , level)values(1,1,12);
insert into skill_requests ( first_name, last_name, furl, department, skill, info) values ( 'Daniel', 'Fulop', 'python-help', 'operations', 'Python', 'Need help with python');
